globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://E:/Projects/Konten-Nuxt/runner-shop/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file://E:/Projects/Konten-Nuxt/runner-shop/node_modules/std-env/dist/index.mjs';
import { eventHandler, setHeaders, sendRedirect, defineEventHandler, handleCacheHeaders, createEvent, getRequestHeader, getRequestHeaders, setResponseHeader, createApp, createRouter as createRouter$1, lazyEventHandler, toNodeListener, getQuery, createError } from 'file://E:/Projects/Konten-Nuxt/runner-shop/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://E:/Projects/Konten-Nuxt/runner-shop/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file://E:/Projects/Konten-Nuxt/runner-shop/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file://E:/Projects/Konten-Nuxt/runner-shop/node_modules/vue/server-renderer/index.mjs';
import { withoutBase, parseURL, withQuery, joinURL } from 'file://E:/Projects/Konten-Nuxt/runner-shop/node_modules/ufo/dist/index.mjs';
import destr from 'file://E:/Projects/Konten-Nuxt/runner-shop/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://E:/Projects/Konten-Nuxt/runner-shop/node_modules/scule/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://E:/Projects/Konten-Nuxt/runner-shop/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://E:/Projects/Konten-Nuxt/runner-shop/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://E:/Projects/Konten-Nuxt/runner-shop/node_modules/hookable/dist/index.mjs';
import { hash } from 'file://E:/Projects/Konten-Nuxt/runner-shop/node_modules/ohash/dist/index.mjs';
import { createStorage } from 'file://E:/Projects/Konten-Nuxt/runner-shop/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://E:/Projects/Konten-Nuxt/runner-shop/node_modules/unstorage/dist/drivers/fs.mjs';
import defu from 'file://E:/Projects/Konten-Nuxt/runner-shop/node_modules/defu/dist/defu.mjs';
import { toRouteMatcher, createRouter } from 'file://E:/Projects/Konten-Nuxt/runner-shop/node_modules/radix3/dist/index.mjs';

const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false}}},"public":{"kontent":{"baseDeliveryApiUrl":"https://deliver.kontent.ai","projectId":"b1df6711-4e2a-023d-c7ae-c75d64d8321a"}}};
...
const serverAssets = [{"baseName":"server","dir":"E:/Projects/Konten-Nuxt/runner-shop/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","base":"E:\\Projects\\Konten-Nuxt\\runner-shop","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","base":"E:\\Projects\\Konten-Nuxt\\runner-shop\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","base":"E:\\Projects\\Konten-Nuxt\\runner-shop\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","base":"E:\\Projects\\Konten-Nuxt\\runner-shop\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_fLuVWR = () => Promise.resolve().then(function () { return renderer$1; });
...
const getClientManifest = () => import('file://E:/Projects/Konten-Nuxt/runner-shop/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://E:/Projects/Konten-Nuxt/runner-shop/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<link rel=\"stylesheet\" href=\"https://fonts.googleapis.com/css2?family=Roboto:wght@100;200;300;400;500;700;900&display=swap\">","bodyTags":"","bodyTagsOpen":"","htmlAttrs":"","bodyAttrs":""};
